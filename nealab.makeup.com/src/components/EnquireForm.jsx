      ...
      <div className="flex flex-col text-white text-lg mt-5 ml-4">
        ...
        <div className="">
          <form
            ...
            action=""
            className="flex flex-col w-3/4 ml-5 text-black"
          >
            <label htmlFor="name" className="my-2 text-white">
              Name
            </label>
            <input
              onChange={(e) => {
            ...
            <label htmlFor="notes" className="my-2 text-white">
              Notes
            </label>
            <textarea
              onChange={(e) => {
            ...
            <div className="mt-4 flex justify-center items-center">
              <button
                type="submit"
                className="text-center text-white border px-2 pt-1 rounded hover:text-NealabPink hover:scale-105 hover:border-NealabPink hover:bg-white"
              >
                Send
              </button>
            </div>
